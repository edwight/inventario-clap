    ...
    <!-- ### $Topbar ### -->
    <?php echo $__env->make('layouts/header_nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="row gap-20 masonry pos-r">
              ...
              <div class="masonry-item  w-100">
                <div class="row gap-20">
                  ...
                  <div class='col-md-3'>
                    <div class="peer">
                            <span class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-red-50 c-red-500"><small>$4.990</small></span>
                        </div>
                    <img width="100%" src="https://img.pystatic.com/products/1852802_20161031162422.jpg"/>
                    <div class="layers bd bgc-white p-20">
                      <div class="layer w-100 mB-10">
                        <h6 class="lh-1">Tempura tori roll (8 cortes)</h6>
                      </div>
                      <div class="layer w-100">
                        <p>Pollo, queso y cebollín, envuelto en alga nori tempura.</p>
                      </div>
                    </div>
                  </div>
