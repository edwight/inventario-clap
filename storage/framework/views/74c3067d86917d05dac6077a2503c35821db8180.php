 ...
 <div class="mail-box">
          ...
          <div class="col-xs-6 col-sm-6 col-md-6 text-right">
            <div class="receipt-right">
              <h5>enviado <?php echo e($detalle->proveedor->nombre); ?></h5>
              <p><?php echo e($detalle->created_at); ?> <i class="fa fa-time"></i></p>
              <h5>recibido <?php echo e($detalle->proveedor->nombre); ?></h5>
              <p><?php echo e($detalle->updated_at); ?> <i class="fa fa-time"></i></p>
          ...
          <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="receipt-left">
              <h1>Receipt</h1>
                          ...
                          <tbody>
                            <?php $__currentLoopData = $detalle->productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                  <td class="col-md-6"><?php echo e($producto->nombre); ?></td>
                                  <td class="col-md-3"><?php echo e($producto->unidad); ?></td>
                                  <td class="col-md-3"><i class="fa fa-inr"></i> <?php echo e($producto->stock); ?></td>
                              </tr>
