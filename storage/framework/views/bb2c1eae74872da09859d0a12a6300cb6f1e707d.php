 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      ...
                      <ul class="inbox-nav inbox-divider">
                          <li class="active">
                              <a href="<?php echo e(asset('/users')); ?>"><i class="fa fa-inbox"></i> User <span class="label label-danger pull-right">2</span></a>

                          </li>
                          <li>
                              <a href="<?php echo e(asset('/reporte')); ?>"><i class="fa fa-envelope-o"></i>Reporte</a>
                          </li>
                          <li>
                                  ...
                                  <table class="table table-inbox table-hover">
                                    <tbody>
                                      ...
                                      <tr class="">
                                          ...
                                          <td class="view-message"><?php echo e($producto->stock); ?></td>
                                          <td class="view-message inbox-small-cells"></td>
