    <?php $__env->startSection('title', 'Proveedor Detalles'); ?>
                 ...
                 <div class="mail-option">
                  ...
                  <div class="col-lg-12 col-sm-12">
                    <div class="card hovercard">
                        ...
                        <div class="card-info"> <span class="card-title"><?php echo e($proveedor->nombre); ?></span>
                      ...
                      <div class="tab-content">
                        <div class="tab-pane fade in active" id="tab1">
                          <h3>formulario </h3>
                            ...
                            <?php echo $__env->make('template.formulario',['proveedor'=>$proveedor,'proveedores'=>$proveedores], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <div class="tab-pane fade in" id="tab2">
                          ...
                          <table class="table table-inbox table-hover">
                            ...
                            <td class="inbox-small-cells">
                              <?php if($detalle->enviado): ?>
                              <i class="fa fa-arrow-circle-up"></i>
                              <?php endif; ?>
                            </td>
                             
                            <td class="view-message dont-show"><?php echo e($detalle->proveedor->nombre); ?></td>
                            <td class="view-message"><?php echo e($detalle->stock); ?></td>
                            <td class="view-message inbox-small-cells"></td>
                              <td class="view-message text-right">
                                <a href="<?php echo e(asset('detalles/'.$detalle->id)); ?>" class="btn btn-success">Detalles</a>
                               </td>
                              <td class="view-message text-right"><?php echo e($detalle->created_at); ?></td>
                            </tr>
                        ...
                        <div class="tab-pane fade in" id="tab4">
                          <?php $__currentLoopData = $proveedor->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p>
                              nombre:<?php echo e($users->name); ?>

                              - correo:<?php echo e($users->email); ?>
