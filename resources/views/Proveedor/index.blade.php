 ...
 <div class="mail-box">
                      ...
                      <div class="inbox-head">
                        ...
                        <div class="inbox-body">
                          ...
                          <form method="post" action="/proveedor">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="name" name="nombre" placeholder="nombre del proveedor" required>
                            </div>
                                    ...
                                    <tbody>
                                      ...
                                      <tr class="">
                                          <td class="inbox-small-cells">
                                              <input type="checkbox" name="proveedor" value="{{$proveedor->id}}" class="mail-checkbox">
                                          </td>
                                          <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                          <td class="view-message dont-show">{{$proveedor->nombre}}</td>
                                          <td class="view-message">lo que sea</td>
    ...
    <script>
        let elemento = new Vue({
            ...
            methods:{
              eliminar:function(){
                console.Info('seguro quiere eliminar este elemento');
              }
            }
        })
    </script>
