        ...
        <div class="mail-box">
            <aside class="sm-side">
                ...
                <ul class="inbox-nav inbox-divider">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-envelope-o"></i>Reporte</a>
                    </li>
                    <li>
            ...
            <aside class="lg-side">
                ...
                <form method="post" action="/detalles">
                    <div class="inbox-body">
                      ...
                      <div class="form-group">
                          <input type="text" class="form-control" id="proveedor" name="proveedor" placeholder="proveedor, clap, centro de acopio" required>
                      </div>
